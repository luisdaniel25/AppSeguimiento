<?php $__env->startSection('title', 'Crear EPS'); ?>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card card-primary">
                ...
                <form action="<?php echo e(route('eps.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="observaciones" name="observaciones"
                                rows="3" required><?php echo e(old('observaciones')); ?></textarea>
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Seguimiento\resources\views\eps\create.blade.php ENDPATH**/ ?>