...
<?php $__env->startSection('title', 'Editar Instructor'); ?>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card card-warning">
                ...
                <form action="<?php echo e(route('instructores.update', $instructor->NIS)); ?>" method="POST" class="form-guardar">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('NumDoc', $instructor->NumDoc)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('Nombres', $instructor->Nombres)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('Apellidos', $instructor->Apellidos)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" rows="3" required><?php echo e(old('Direccion', $instructor->Direccion)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('Telefono', $instructor->Telefono)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('CorreoInstitucional', $instructor->CorreoInstitucional)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('CorreoPersonal', $instructor->CorreoPersonal)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" required>
                                ...
                                <option value="1" <?php echo e(old('Sexo', $instructor->Sexo) == 1 ? 'selected' : ''); ?>>
                                    Masculino</option>
                                <option value="2" <?php echo e(old('Sexo', $instructor->Sexo) == 2 ? 'selected' : ''); ?>>Femenino
                                </option>
                            </select>
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('FechaNac', \Carbon\Carbon::parse($instructor->FechaNac)->format('Y-m-d'))); ?>"
                                required>
...
unset($__errorArgs, $__bag); ?>" required>
                                ...
                                <?php $__currentLoopData = $tiposdoc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($tipo->nis); ?>"
                                        <?php echo e(old('tbl_tiposdocumentos_nis', $instructor->tbl_tiposdocumentos_nis) == $tipo->nis ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <?php $__currentLoopData = $listaEps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $epsItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($epsItem->nis); ?>"
                                        <?php echo e(old('tbl_eps_nis', $instructor->tbl_eps_nis) == $epsItem->nis ? 'selected' : ''); ?>>
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Seguimiento\resources\views\Instructores\edit.blade.php ENDPATH**/ ?>